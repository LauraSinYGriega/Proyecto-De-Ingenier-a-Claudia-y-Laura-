 ...
 * En esta versión se encuentra desarrollado el código de la siguiente manera:
 * - Funciones que generan los número aleatorios.
 * - Clase Main que contiene:
 * 		- Bloque de construcción de valores aleatorios. 
 * 		- Bloque de creacción del fichero csv. Solo se escribe una línea de valores aleatorios. Es simple.
 * 		- Bloque de impresión del fichero csv. creado.
 */

public class Proyecto_Ing_V1_Main {
	...
	public static void main(String[] args) {
		...
		try {
			fichero = new FileWriter ("pruebaVersion1.csv");
